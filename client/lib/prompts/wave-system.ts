 ...
 * Canonical Gemma System Prompt. Every check-in turn (Turns 3, 4, 5)
 * generated by the LoRA stand-in (gpt-5-mini today, in-browser
 * Gemma 4 E2B-it tomorrow) sees this exact text as its system message.
 *
 ...
 *
 * The prompt is written in plain prose (NOT XML-tagged) because it
 * loads into the chat-style multi-turn surface, not the one-shot phase
 * narration surface. The XML-tagged format used in body-scan.ts,
 * medication-ack.ts, and wave.ts is a convention for the legacy
