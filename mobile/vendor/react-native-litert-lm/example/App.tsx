...
import { WaveEvalScreen, WAVE_AUTORUN } from "./wave-eval/WaveEvalScreen";
...
function Main() {
  ...
  const [screen, setScreen] = useState<"chat" | "wave">(
    WAVE_AUTORUN ? "wave" : "chat",
  );
  ...
  if (screen === "wave") {
    return (
      <SafeAreaView style={s.root}>
        <WaveEvalScreen onBack={() => setScreen("chat")} />
      </SafeAreaView>
    );
  }
      ...
      >
        ...
        <View style={s.header}>
          ...
          <View style={{ flexDirection: "row", gap: 8 }}>
            <TouchableOpacity
              style={s.settingsBtn}
              onPress={() => setScreen("wave")}
              accessibilityLabel="Open Wave eval suite"
            >
